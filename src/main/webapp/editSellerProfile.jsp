            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card shadow-2-strong card-registration rounded mb-3">
                    <div class="card-body p-4 p-md-5">
                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Edit Profile - Seller</h3>
                        <form class="row g-3 needs-validation" action="SellerServlet?user=${user.userType}&action=editSeller" method="post" novalidate >
